...
{
	/// <summary>
	/// Represents a application service exception.
	/// </summary>
	public class ApplicationServiceException : ApplicationModelException
	{
		/// <summary>
		/// Initializes a new instance of the WrappedException class.
		/// </summary>
        public ApplicationServiceException() : base() { }

        /// <summary>
        /// Initializes a new instance of the WrappedException class.
        /// </summary>
        /// <param name="number">The exception type that will escalate to the presentation layer.</param>
        public ApplicationServiceException(long number)
        ...
        /// <param name="number">The exception type that will escalate to the presentation layer.</param>
        /// <param name="message"> The message that describes the error.</param>
        public ApplicationServiceException(long number, string message)
            : base(number, message) { }
        ...
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception, or a null reference if no inner exception is specified.</param>
        public ApplicationServiceException(long number, string message, Exception innerException)
		...
		protected ApplicationServiceException(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
	}
}
